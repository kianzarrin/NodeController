    ...
    static class ClipSegmentEndPatch {
        ...
        public static IEnumerable<CodeInstruction> Transpiler(
            ...
            CodeInstruction ldarg_startNodeID =
                GetLDArg(original, "startNodeID", throwOnError: false) ??
                GetLDArg(original, "startNodeID", throwOnError: true);
            CodeInstruction ldarg_segmentID =
                GetLDArg(original, "ignoreSegmentID", throwOnError: false) ??
                GetLDArg(original, "ignoreSegmentID", throwOnError: true);
