namespace NodeController.Patches {
    ...
    public class LoadPathsPatch {
        ...
        public static bool Mapping => Index != -1 && PathInfoExts != null;
        ...
        public static void Prefix(BuildingInfo info) {
            ...
            Prefab = info;
            if (!AssetDataExtension.Instance.Asset2PathInfoExts.TryGetValue(info, out PathInfoExts)) {
                PathInfoExts = null;
            }
        }
        ...
        public static ushort GetMappedNodeID(ushort oldNodeId, Dictionary<InstanceID, InstanceID> map) {
            return map[new InstanceID { NetNode = oldNodeId }].NetNode;
        }
